      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="right" showCloseButton={false} className="w-full max-w-sm p-0">
          ...
          <div className="border-t p-5 space-y-3">
            <a href="tel:+9779761506543" className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-muted text-sm font-medium">
              <Phone className="h-4 w-4" />
              +977-9761506543
            </a>
            <a href="https://wa.me/9779761506543" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-[#25D366] text-white text-sm font-medium">
