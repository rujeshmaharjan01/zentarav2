...
export async function generateMetadata({
  ...
  const pkg = await prisma.package.findUnique({
    ...
    select: {
      ...
      imageUrl: true,
      price: true,
      destinationRel: { select: { name: true } },
    },
  });
  if (!pkg) return {};
  return {
  ...
  return (
    <>
      <TouristTripJsonLd
        ...
        url={`${process.env.NEXT_PUBLIC_APP_URL}/packages/${pkg.id}`}
      ...
      <div className="container mx-auto px-4 py-8 pb-24 lg:pb-8">
        ...
        <Breadcrumb aria-label="Breadcrumb" className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <span className="font-medium text-foreground truncate max-w-50 inline-block">
                {pkg.title}
              </span>
            </BreadcrumbItem>
          </BreadcrumbList>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8">
          ...
          <div className="space-y-10">
            ...
            <section
              ...
              className="scroll-mt-28"
            >
              <h2 id="includes-heading" className="text-xl font-semibold mb-4">
                Includes & Excludes
              </h2>
              <IncludeExclude />
            </section>
            ...
            <section
              ...
              className="scroll-mt-28"
            >
              <h2 id="why-us-heading" className="text-xl font-semibold mb-4">
                Why Book With Us
              </h2>
              <WhyBookUs />
            </section>
            ...
            <section
              ...
              className="scroll-mt-28"
            >
              <h2 id="faqs-heading" className="text-xl font-semibold mb-4">
            ...
            <section aria-labelledby="similar-heading">
              <h2 id="similar-heading" className="text-xl font-semibold mb-4">
                You Might Also Like
              </h2>
          ...
          <div className="hidden lg:block">
            <div className="sticky top-31">
              <BookingForm
                ...
                packageDestination={pkg.destinationRel?.name ?? ""}
                price={pkg.price}
                maxGroupSize={pkg.maxGroupSize}
              />
