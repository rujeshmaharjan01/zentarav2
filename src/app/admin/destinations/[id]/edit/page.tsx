    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <Textarea rows={2} value={form.bestTime} onChange={(e) => setForm({ ...form, bestTime: e.target.value })} className={errors.bestTime ? "border-destructive" : ""} />
        ...
        <Card>
          ...
          <CardContent>
            <Textarea rows={4} value={form.travelTips} onChange={(e) => setForm({ ...form, travelTips: e.target.value })} />
          </CardContent>
        </Card>
