...
export default function NewDestinationPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <h1 className="text-2xl sm:text-3xl font-bold">New Destination</h1>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="name" value={form.name} onChange={(e) => { setForm({ ...form, name: e.target.value, slug: form.slug || autoSlug(e.target.value) }); }} className={errors.name ? "border-destructive" : ""} />
